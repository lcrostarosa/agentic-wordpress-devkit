...
**For detailed templates**: See [sequence-templates.md](../../../../references/copy/sequence-templates.md)
...
**For detailed email type reference**: See [email-types.md](../../../../references/copy/email-types.md)
...
**For detailed copy, personalization, and testing guidelines**: See [copy-frameworks.md](../../../../references/copy/copy-frameworks.md)
