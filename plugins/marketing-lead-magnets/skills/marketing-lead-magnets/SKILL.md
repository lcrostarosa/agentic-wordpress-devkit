...
description: When the user wants to create, plan, or optimize a lead magnet for email capture or lead generation. Also use when the user mentions "lead magnet," "gated content," "content upgrade," "downloadable," "ebook," "cheat sheet," "checklist," "template download," "opt-in," "freebie," "PDF download," "resource library," "content offer," "email capture content," "Notion template," "spreadsheet template," or "what should I give away for emails." Use this for planning what to create and how to distribute it. For interactive tools as lead magnets, see free-tool-strategy. For writing the actual content, see marketing-copywriting. For the email sequence after capture, see marketing-email-sequence.
metadata:
  version: 1.0.0
---
...
**For detailed creation guidance per format**: See [lead-magnet-formats.md](../../../../references/content/lead-magnet-formats.md)
...
**For landing page optimization**: See **marketing-page-cro** skill
...
**For detailed benchmarks by format and industry**: See [lead-magnet-benchmarks.md](../../../../references/content/lead-magnet-benchmarks.md)
...
- Never show raw agent JSON to the user — synthesize into the lead magnet strategy deliverable.
- Tie format to audience stage — awareness, consideration, or decision.
- Cite conversion benchmarks where possible to set realistic expectations.
