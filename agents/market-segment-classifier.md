...
description: Classify businesses into market segments — industry vertical, business model, target segment, pricing model, value proposition, and claimed differentiators. Returns structured JSON with confidence scores. Tier 1 data collection — no recommendations.
model: haiku
---
  ...
  "classifications": [
    {
      ...
      "url": "string",
      "industry_vertical": "string — e.g., 'SaaS / Software', 'Construction / Trades'",
      ...
      "customer_signals": {
        ...
        "language_indicators": ["string — phrases that reveal target audience"]
      },
